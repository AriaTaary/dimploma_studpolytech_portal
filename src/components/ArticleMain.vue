  ...
  <div class="main-card-info">
    ...
    <div class="card-main-info">
      ...
      <div class="ratings">
        ...
        <button
          v-if="article.rating_users.filter(ratingUser => ratingUser.user_id === this.$store.getters.getUser.id).length !== 0"
          class="post-button post-button-active"
          @click="likeArticle()"
        >
          <div class="likes">
        ...
        <button v-if="article.saved_users.filter(user => user.id === this.$store.getters.getUser.id).length !== 0" class="post-button post-button-active" @click="saveArticle()">
          <div class="bookmarks">
